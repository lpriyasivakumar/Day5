...
public class GuessingGame {
	...
	public static void main(String[] args) {
		...
		String choice = "y";// hardcoded choice as "y" so While loop runs at
							// least once
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			count = 1;
			// Call the compare method to compare the guess and random number if
			// guess is wrong
			...
			System.out.printf("Great you guessed right. It took you %d tries.",
					count);
			choice = Validator
					.getChoice(sc, "Do you want to play again? y/n: ");
		}
		sc.close();
